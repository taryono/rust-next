        ...
        >
          ...
          {loginError && (
            <div
              ...
              style={{ fontSize: ".83rem", borderRadius: 10 }}
            >
          ...
          <form onSubmit={handleLogin}>
            ...
            >
              <div className="form-check">
                ...
                <label className="form-check-label" htmlFor="rememberMe" style={{ fontSize: ".82rem", color: "#374151" }}>
                  Remember me
                </label>
              </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "20px 0", fontSize: ".78rem", color: "#6B7280" }}>

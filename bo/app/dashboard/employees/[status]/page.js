...
export default function EmployeesStatus({params}) {
  ...
  const {
    ...
    changePerPage,
    updateFilters,
  } = usePagination(api.getEmployees);
  ...
  const fetchEmployees = async () => {
    try {
      ...
      const response = await api.getEmployees(`?${params.toString()}`);
      ...
      alertError('Failed to fetch employees');
    } finally { 
    }
  };
                                ...
                                <div className="card-body">
                                  <div className="d-flex align-items-center mb-3">
                                    ...
                                    <div className="flex-fill">
                                      <div className="font-weight-medium">{employee.name}</div>
                                      <div className="text-secondary small">{employee.email}</div>
                                    </div>
                                  </div> 
                                </div>
                              </div>

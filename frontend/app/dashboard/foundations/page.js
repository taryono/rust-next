...
export default function Foundations() {
  ...
  const fetchFoundations = async () => {
    try {
      ...
      alertError('Failed to fetch foundations');
    } finally { 
    }
  };
  ...
  if (loading && foundations.length === 0) {
    return (
      <AuthLayout>
        <Loader title={"Loading Foundations...."} /> 
      </AuthLayout>
    );
  } 
  return (
      ...
      <div className="page">
        <div className="page-wrapper"> 
            ...
            <div className="container-xl">
              <div className="row g-2 align-items-center">
                <div className="col">
                  ...
                  <h2 className="page-title">Foundations Management</h2>
                </div>
          ...
          <div className="page-body">
            <div className="container-xl">
              <div className="card">
                <CardHeader title={"Foundation List"} viewMode={viewMode} onViewModeChange={setViewMode} />

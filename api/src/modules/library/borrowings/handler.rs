...
pub async fn create(
    ...
    request: web::Json<CreateBorrowingRequest>,
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Borrowing found", body = BorrowingResponse),
...
pub async fn get_by_id(
    ...
    let result = app_state.borrowing_service.get_by_id(id.into_inner()).await?;
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "List of students", body = PaginatedResponse<BorrowingResponse>)
    ),
    tag = "Borrowing "
)]
pub async fn get_all(
    ...
    let result = app_state.borrowing_service.get_all(params, None).await?;
...
#[utoipa::path(
    ...
    request_body = UpdateBorrowingRequest,
    responses(
        (status = 200, description = "Borrowing updated", body = BorrowingResponse),
        (status = 404, description = "Borrowing not found"),
...
pub async fn update(
    app_state: web::Data<AppState>,
    id: web::Path<i64>,
    request: web::Json<UpdateBorrowingRequest>,
) -> Result<HttpResponse, AppError> {
    let result = app_state
        .borrowing_service
...
pub async fn delete(
    ...
    app_state.borrowing_service.delete(id.into_inner()).await?;
